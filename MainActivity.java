...
public class MainActivity extends AppCompatActivity {
    ...
    private void showSignup() {
        ...
        create.setOnClickListener(v -> {
            ...
            if (n.isEmpty() || e.isEmpty() || p.length() < 6) {
                ...
                toast(
                        "Enter name, valid email and 6+ character password"
                );
    ...
    private void showHome() {
        ...
        /*
         * VIDEO PLAYER
         * SurfaceView की जगह VideoView इस्तेमाल किया गया है।
         * इससे video का picture/rendering ज्यादा reliable रहेगा।
         */
        ...
        delete.setOnClickListener(v -> {
            ...
            toast(
                    "Selected video removed from this screen"
            );
        });
        ...
        myDashboard.setOnClickListener(v ->
                showMyDashboard()
        );
    ...
    private void searchUsersForMessage() {
        ...
        addTitle(
                "Find User For Message"
        );

        EditText q =
                input("User email beginning");
